...
public class GuiShader extends ShaderProgram {
     ...
     */
    private static final String VERTEX_FILE = SHADER_PATH + "gui/" + "guiVertexShader.txt";

    /**
     * Dateipfad des Fragment Shaders.
     */
    private static final String FRAGMENT_FILE = SHADER_PATH + "gui/" + "guiFragmentShader.txt";

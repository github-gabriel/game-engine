package de.gabriel.engine.skybox;
...
public class SkyboxShader extends ShaderProgram {
     ...
     */
    private static final String VERTEX_FILE = SHADER_PATH + "/skybox/" + "skyboxVertexShader.glsl";

    /**
     * Dateipfad des Skybox Fragment Shaders.
     */
    private static final String FRAGMENT_FILE = SHADER_PATH + "/skybox/" + "skyboxFragmentShader.glsl";
